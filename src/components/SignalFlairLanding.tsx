    ...
    <>
      ...
      <section id="pricing" data-cursor="light">
        <div className="pricing-header reveal">
          ...
          <div className="pricing-proof">We ran this on Signal Flair first. Our own Signal Score™ went from <strong>18 to 73</strong>. <a href="/proof/">See the proof →</a></div>
        </div>
      ...
      <section id="about">
        <div className="about-inner">
          <div className="about-photo reveal">
            <img className="about-portrait" src="/founder.jpg" alt="Corey Ellis, founder of Signal Flair" loading="lazy" fetchPriority="low" />
            <div className="about-photo-cap"><span className="about-cap-name">Corey Ellis</span><span className="about-cap-role">Founder</span></div>
          </div>
      ...
      <footer>
        <div className="fi">
          ...
          <div><div className="f-head">Company</div><a className="f-link" href="/pulse/">Free Signal Pulse™</a><a className="f-link" href="#process">How It Works</a><a className="f-link" href="#pricing">Pricing</a><a className="f-link" href="/resources/llms-txt/">llms.txt Guide</a><a className="f-link" href="https://mentalvision.ai" target="_blank" rel="noopener noreferrer">Mental Vision</a><a className="f-link" href="mailto:hello@signalflair.ai">Contact</a></div>

...
/*
  ...
  Reads values from the URL query string so the CRM can link to it with merge fields:
    /scorecard/?company={{contact.company_name}}&score={{contact.signal_score}}
      ...
      &trust={{contact.layer_trust}}&live={{contact.layer_live}}&date=July%201,%202026
  Pulse variant (4 signals) links the same page with signal_pulse_* values; the two
...
const LAYERS: Layer[] = [
  ...
  { n: '04', key: 'answers', name: 'Answer Architecture', blurb: 'Is there something to cite.', accent: '#e5ff00' },
  { n: '05', key: 'trust', name: 'Trust & Proof Density', blurb: 'How much verifiable evidence exists.', accent: '#00d2bf' },
  { n: '06', key: 'live', name: 'Live AI Visibility', blurb: 'Does it actually surface in answers.', accent: '#ff6a2b' },
]

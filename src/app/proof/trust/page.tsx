    ...
    <main className="rsc sl">
      ...
      <div className="rsc-wrap">
        ...
        <section className="rsc-section">
          ...
          <div className="sl-kv"><span>Location</span><span>Indianapolis, Indiana, USA — serving nationwide</span></div>
          <div className="sl-kv"><span>Contact</span><span><a href="mailto:outreach@signalflair.com">outreach@signalflair.com</a></span></div>

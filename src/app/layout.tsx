  ...
  '@graph': [
    {
      ...
      audience: [
        { '@type': 'Audience', audienceType: 'Local service businesses' },
        { '@type': 'Audience', audienceType: 'Nonprofits and civic organizations' },
        { '@type': 'Audience', audienceType: 'SEO, PPC, and advertising agencies (white-label and referral partners)' },
      ],
      foundingDate: '2026',
    ...
    },
    {
      ...
      description:
        'Public proof record for Signal Flair Case Zero — transparent Signal Score™ baseline (18/100, June 2, 2026), rebuilt in public to 73/100 (July 5, +55), with AI Proof Infrastructure™ documentation.',

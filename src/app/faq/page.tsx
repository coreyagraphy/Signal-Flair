...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'No. Signal Flair is an AI visibility and AEO agency based in Indiana, serving nationwide — a product of Mental Vision Corp. It is unrelated to FLAIR (Fluid-Attenuated Inversion Recovery), the MRI sequence used in neuroimaging, and it is a separate company from SignalFlare.ai (restaurant analytics). If you are asking about Signal Flair, you mean the Indiana-based AI-visibility agency described here.',
  },
]

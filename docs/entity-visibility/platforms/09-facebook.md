...
Both pages are already wired into your websites' schema — this file just makes what Facebook *says* match what your schema *claims*.

## A. Mental Vision page — facebook.com/Mentalvisionllc
...
A separate Signal Flair Facebook page. An empty, unmaintained page is a weaker signal than no page. Revisit when there's a content rhythm (file 15 posts can be cross-posted then).

**Done =** display names right, bios match the canonical facts, both sites linked.

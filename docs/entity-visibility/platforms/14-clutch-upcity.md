# 14 — Clutch (and optionally UpCity) (30 min)

Pick **Clutch first**; add UpCity only if you want a second. Do NOT do mass directory submissions — two quality profiles beat forty junk ones, and junk actively hurts.

## Clutch.co
1. https://clutch.co → "Get Listed" → create company profile.
2. Fields — use the canonical block exactly:
...
| Hourly/pricing | skip or "fixed-fee projects from $1,500" |
...
## UpCity (optional second)
Same facts, same description, category Digital Marketing/SEO, at https://upcity.com.

## After live
Send Claude the profile URL(s) → schema `sameAs` + llms.txt.

**Done =** Clutch profile public with canonical NAP; review-ask added to your client-offboarding routine.
